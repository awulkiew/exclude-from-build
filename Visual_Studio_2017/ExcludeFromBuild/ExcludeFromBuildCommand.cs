...
namespace ExcludeFromBuild
{
    ...
    internal sealed class ExcludeFromBuildCommand
    {
        ...
        private ExcludeFromBuildCommand(Package package, OleMenuCommandService commandService)
        {
        ...
        public static void Initialize(ExcludeFromBuildPackage package)
        {
            ...
            Instance = new ExcludeFromBuildCommand(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            Util.SetExcludedFromBuild(dte, true);
        }
