...
namespace ExcludeFromBuild
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class IncludeInBuildActiveCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private IncludeInBuildActiveCommand(Package package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static IncludeInBuildActiveCommand Instance
        {
            get;
            private set;
        }
        ...
        public static void Initialize(ExcludeFromBuildPackage package)
        {
            ...
            Instance = new IncludeInBuildActiveCommand(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            Util.SetExcludedFromBuild(dte, false, false);
        }
    }
}
