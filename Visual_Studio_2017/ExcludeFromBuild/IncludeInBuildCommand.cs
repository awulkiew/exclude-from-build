...
namespace ExcludeFromBuild
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class IncludeInBuildCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private IncludeInBuildCommand(Package package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static IncludeInBuildCommand Instance
        {
            get;
            private set;
        }
        ...
        public static void Initialize(ExcludeFromBuildPackage package)
        {
            ...
            Instance = new IncludeInBuildCommand(package, commandService);
        }
