...
namespace ExcludeFromBuild
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ExcludeFromBuildAllCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private ExcludeFromBuildAllCommand(Package package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static ExcludeFromBuildAllCommand Instance
        {
            get;
            private set;
        }
        ...
        public static void Initialize(ExcludeFromBuildPackage package)
        {
            ...
            Instance = new ExcludeFromBuildAllCommand(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            Util.SetExcludedFromBuild(dte, true, true);
        }
