...
namespace ExcludeFromBuild
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class IncludeInBuildAllCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private IncludeInBuildAllCommand(Package package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static IncludeInBuildAllCommand Instance
        {
            get;
            private set;
        }
        ...
        public static void Initialize(ExcludeFromBuildPackage package)
        {
            ...
            Instance = new IncludeInBuildAllCommand(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            Util.SetExcludedFromBuild(dte, false, true);
        }
    }
}
